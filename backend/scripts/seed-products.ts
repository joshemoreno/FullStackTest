...
async function run() {
  ...
  const items = [
    ...
    {
      productId: 'p-004',
      name: 'Escritorio Multiple',
      description: 'Producto de prueba para checkout',
      price_in_cents: 1500000,
      imageUrl: 'https://compumuebles.com/cdn/shop/products/M05_Escritorio_Multiple_P_1200x1200.jpg?v=1596901415',
      stock: 10,
      active: true,
      createdAt: now,
      updatedAt: now,
    ...
    {
      productId: 'p-005',
      name: 'Caja para torre',
      description: 'Producto de prueba para checkout',
      price_in_cents: 1000000,
      imageUrl: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcROrrtuP3mxF146punwnCDW1fEbRaOCAke-_w&s',
      stock: 0,
      active: true,
      createdAt: now,
      updatedAt: now,
    },
    {
      ...
      imageUrl: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQOCuj3AAVSN4sc5KYWoJaOmreIc4bYKAh1Ow&s',
      stock: 15,
      active: true,
      createdAt: now,
      updatedAt: now,
